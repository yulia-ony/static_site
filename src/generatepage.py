...
def generate_page(from_path, template_path, dest_path, basepath):
    ...
    # Replace basepath for links and images
    rendered_content = rendered_content.replace('href="/', f'href="{basepath}')
    rendered_content = rendered_content.replace('src="/', f'src="{basepath}')
